...
This repository contains the official n8n community node for **fynk** — an AI contract management platform for creating, storing, managing, and legally signing documents. It lets n8n users automate document workflows: generating contracts, proposals, NDAs, and other agreements from templates, assigning parties and signatories, and moving documents into signing.

Read `.agents/product.md` for full product and positioning context before working on any user-facing text.
...
| User-facing text, README, keywords, descriptions | `.agents/product.md`            |
